	...
	for _, tst := range testResults {
		t.Run(tst.name, func(t *testing.T) {
			testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
				...
				result, err := store.Find(badgerhold.Where("UpdateIndex").Eq("updated index").
...
func TestIssue14(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		result, err := store.Find(badgerhold.Where("Category").Eq("Test Category"))
		if err != nil {
...
func TestIssue14UpdateMatching(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		err = store.UpdateMatching(badgerhold.Where("Name").Eq("Test Name"),
			func(record *ItemTest) error {
				update := record
...
func TestInsertSequence(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		store := generichold.Open[SequenceTest](bh)
...
func TestInsertSequenceSetKey(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		store := generichold.Open[InsertSequenceSetKeyTest](bh)
...
func TestInsertSetKey(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		store := generichold.Open[TestInsertSetKey](bh)
...
func TestAlternateTags(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		store := generichold.Open[TestAlternate](bh)
		...
		result, err := store.Find(badgerhold.Where("Name").Eq(item.Name).Index("Name"))
		if err != nil {
...
func TestUniqueConstraint(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		store := generichold.Open[TestUnique](bh)
		...
		t.Run("UpdateMatching", func(t *testing.T) {
			...
			err = store.UpdateMatching(badgerhold.Where(badgerhold.Key).Eq(update.Key),
				func(r *TestUnique) error {
					record := r
...
func TestIssue46ConcurrentIndexUpdateMatching(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		for i := range testData {
			...
			go func(gt *testing.T, i int) {
				defer wg.Done()
				err := store.UpdateMatching(badgerhold.Where(badgerhold.Key).
					Eq(testData[i].Key), func(r *ItemTest) error {
					record := r
...
func TestInsertUpdateIndexError(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		store := generichold.Open[CustomStorer](bh)
