...
func TestFindAggregateGroup(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		result, err := store.FindAggregate(nil, "Category")
...
func TestFindAggregateMultipleGrouping(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		result, err := store.FindAggregate(nil, "Category", "Color")
...
func TestFindAggregateGroupPointerPanic(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		result, _ := store.FindAggregate(nil, "Category")
...
func TestFindAggregateBadGroupField(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, err := store.FindAggregate(nil, "BadField")
		if err == nil {
...
func TestFindAggregateWithNoResult(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		result, err := store.FindAggregate(badgerhold.Where("Name").
...
func TestFindAggregateWithNoGroupBy(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		result, err := store.FindAggregate(nil)
		if err != nil {
