...
func insertTestData(t *testing.T, store generichold.Store[ItemTest]) {
...
// NOTE: now, this check perform at compile time
...
func TestFindWithNilValue(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, err := store.Find(badgerhold.Where("Name").Eq(nil))
		if err == nil {
...
// NOTE: unnecessary, pointer always pass in generichold
...
//			}
//		}()
//		_, _ = store.Find(badgerhold.Where("Name").Eq("blah"))
//	})
//}
...
func TestFindOnInvalidFieldName(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, err := store.Find(badgerhold.Where("BadFieldName").Eq("test"))
		if err == nil {
...
func TestFindOnInvalidIndex(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, err := store.Find(badgerhold.Where("Name").Eq("test").Index("BadIndex"))
		if err == nil {
...
func TestFindOnEmptyBucketWithIndex(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		result, err := store.Find(badgerhold.Where("Category").Eq("animal").Index("Category"))
		if err != nil {
...
func TestSkip(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		skipResult, err := store.Find(q.Skip(skip))
		if err != nil {
...
func TestSkipNegative(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, _ = store.Find(badgerhold.Where("Name").Eq("blah").Skip(-30))
	})
}
...
func TestLimitNegative(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, _ = store.Find(badgerhold.Where("Name").Eq("blah").Limit(-30))
	})
}
...
func TestSkipDouble(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, _ = store.Find(badgerhold.Where("Name").Eq("blah").Skip(30).Skip(3))
	})
}
...
func TestLimitDouble(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, _ = store.Find(badgerhold.Where("Name").Eq("blah").Limit(30).Limit(3))
	})
}
...
func TestSkipInOr(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, _ = store.Find(badgerhold.Where("Name").Eq("blah").Or(badgerhold.Where("Name").Eq("blah").Skip(3)))
	})
}
...
func TestLimitInOr(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, _ = store.Find(badgerhold.Where("Name").Eq("blah").Or(badgerhold.Where("Name").Eq("blah").Limit(3)))
	})
}

// NOTE: now, this unavailable due to compile time type assertion
...
func TestKeyMatchFunc(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, _ = store.Find(badgerhold.Where(badgerhold.Key).MatchFunc(func(ra *badgerhold.RecordAccess) (bool, error) {
			field := ra.Field()
			_, ok := field.(string)
			if !ok {
				return false, fmt.Errorf("Field not a string, it's a %T!", field)
...
func TestKeyStructTag(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		store := generichold.Open[KeyTest](bh)
		...
		result, err := store.Find(badgerhold.Where(badgerhold.Key).Eq(key))
		if err != nil {
...
func TestQueryIterKeyCacheOverflow(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		store := generichold.Open[KeyCacheTest](bh)
...
func TestNestedStructPointer(t *testing.T) {
	...
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		store := generichold.Open[device](bh)
...
func TestFindOne(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		for _, tst := range testResults {
			t.Run(tst.name, func(t *testing.T) {
				result, err := store.FindOne(tst.query)
...
// NOTE: unnecessary, compile time type assertion
...
func TestCount(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		for _, tst := range testResults {
			t.Run(tst.name, func(t *testing.T) {
				count, err := store.Count(tst.query)
				if err != nil {
...
func TestIssue74HasPrefixOnKeys(t *testing.T) {
	testWrap(t, func(bh *badgerhold.Store, t *testing.T) {
		...
		_, err := store.FindOne(badgerhold.Where(badgerhold.Key).HasPrefix("test"))
		ok(t, err)

		_, err = store.FindOne(badgerhold.Where(badgerhold.Key).HasSuffix("test"))
		ok(t, err)
	})
}
